...
import { BoxGeometry, Mesh, RingGeometry } from "three";
...
export function switchPick(camera0, name) {
	...
	switch (name) {
		case "left":
			...
			tween.to({ pos: { x: 0, y: 0, z: 1000 } }, speedTween);
			break;
		case "right":
			// camera0.position.x = 0;
			// camera0.position.y = 0;
		...
		case "top":
			...
			tween.to({ pos: { x: 0, y: 1000, z: 0 } }, speedTween);
			break;
		case "bottom":
			// camera0.position.x = 0;
			// camera0.position.y = -1000;
		...
		case "front":
			...
			// camera0.position.y = 0;
			// camera0.position.z = 0;
			tween.to({ pos: { x: 1000, y: 0, z: 0 } }, speedTween);
			break;
		case "back":
			// camera0.position.x = -1000;
			// camera0.position.y = 0;
		...
		case "left_front":
			...
			// camera0.position.y = 0;
			// camera0.position.z = 1000;
			tween.to({ pos: { x: 1000, y: 0, z: 1000 } }, speedTween);
		...
		case "top_left":
			...
			// camera0.position.y = 1000;
			// camera0.position.z = 1000;
			tween.to({ pos: { x: 0, y: 1000, z: 1000 } }, speedTween);
		...
		case "top_front":
			...
			// camera0.position.y = 1000;
			// camera0.position.z = 0;
			tween.to({ pos: { x: 1000, y: 1000, z: 0 } }, speedTween);
		...
		case "top_left_front":
			...
			// camera0.position.y = 1000;
			// camera0.position.z = 1000;
			tween.to({ pos: { x: 1000, y: 1000, z: 1000 } }, speedTween);
